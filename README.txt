...
- For docker compose to run, please replace all the 'jingweisim' in docker-compose.yml to your docker ID. Once the Kong GUI is running, please import the esd-kong-postgres.json file placed in this same directory. This will allow our API Gateway to function.
